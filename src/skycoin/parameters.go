...
func setDefaults() {
	// node defaults
	viper.SetDefault("node.genesis_coin_volume", 300e12)
	viper.SetDefault("node.port", 30000)
	viper.SetDefault("node.web_interface_port", 7220)
	...
	viper.SetDefault("visor.max_coin_supply", 3e8)
